import CustomCarousel from "@/src/components/ui/Testing/customCarousel";

export default function Home() {
  return (
    <main className="p-4">
      <h1 className="text-2xl font-bold mb-4">Custom Carousel Example</h1>
      <CustomCarousel itemsToShow={3}>
